...
DEFAULTS = {
    ...
    'PIPELINE_ORDER': ['sharpen', 'blur', 'contrast', 'exposure', 'gamma', 'color_to_transparent', 'alpha_outline', 'dither', 'invert', 'pixelate', 'fill', 'color_replace', 'rectangle', 'line', 'edge_outline', 'grain'],
